...
del asmExample.lst	REM asmExample可以替換成.asm檔的檔名
del asmExample.obj
del asmExample.ilk
del asmExample.pdb
del asmExample.exe
...
LINK /INCREMENTAL:no /debug /subsystem:console  /entry:start /out:asmExample.exe asmExample.obj Kernel32.lib irvine32.lib user32.lib
if errorlevel 1 goto terminate
